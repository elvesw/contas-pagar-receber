...
public class ContasPagarBean extends AbstractBean{
	...
	public String verPDF(ActionEvent actionEvent) throws Exception{
		...
		try {
			Map<String, Object> parametros = new HashMap<String,Object>();
				parametros.put("titulo","Contas a pagar");
			...
			RelatorioUtil relatorio=new RelatorioUtil();
				relatorio.verPdfBrowser(lancamentoDS,parametros,"Lancamentos.jrxml","ContasPagar"+DataUtil.ddMMyy(new Date()));
		} catch (Exception e) {
	...
	private void carregaListas(){
		if(listaCategorias.isEmpty()){
			listaCategorias=categoriaService.listaCategoriasPorTipo(TipoDeLancamento.SAÍDA);
		}
